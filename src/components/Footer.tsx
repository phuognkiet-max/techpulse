        ...
        <div className="mx-auto max-w-[1200px] px-4 sm:px-6">
            ...
            <div>
              ...
              <form onSubmit={handleNewsletter} className="flex gap-2">
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="flex-shrink-0 rounded-lg bg-[var(--accent)] px-4 py-2 text-sm font-medium text-white hover:bg-[var(--accent-hover)] disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                >
                  {loading ? "..." : "Đăng ký"}
                </button>
              </form>
          ...
          <div className="border-t border-[var(--border)] py-5 flex flex-col md:flex-row items-center justify-between gap-3">
            <p className="text-xs text-[var(--text-muted)]">
              © {new Date().getFullYear()} {siteSettings?.title || "TechPulse"}. All rights reserved.
            </p>
