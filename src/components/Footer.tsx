            ...
            <div className="flex gap-3">
              {footerLinks.social.map((social) => (
                <a
                  ...
                  className="flex h-9 w-9 items-center justify-center rounded-lg border border-[var(--border)] text-[var(--text-secondary)] hover:text-[var(--text-primary)] hover:border-[var(--accent)] hover:bg-[var(--bg-card)] transition-all"
                >
                  {social.icon}
                </a>
              ))}
